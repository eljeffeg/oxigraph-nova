...
//! are ever visible. `oxigraph_nova_engine_ring::LoudsStore` gives per-call
...
//! the whole "query".
//!
//! See `crates/engines/nova-engine-louds/src/store.rs`'s module doc comment
//! ("Isolation semantics") and `crates/core/nova-query/src/update.rs`'s module
